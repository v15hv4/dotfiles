...
let s:gb.dark0_hard  = ['#080808', 233]     " 29-32-33
...
let s:gb.light1      = ['#c6c6c6', 251]     " 235-219-178
...
" MODIFIED COLORS
let s:gb.bright_red     = ['#ff875f', 209]     " orange
let s:gb.bright_green   = ['#fabd2f', 214]     " yellow
let s:gb.bright_blue  = ['#fabd2f', 214]     " yellow
let s:gb.bright_yellow    = ['#afd7ff', 153]     " blue
let s:gb.bright_purple  = ['#d7afff', 183]     " purple
let s:gb.bright_orange    = ['#8ec07c', 108]     " green
let s:gb.bright_aqua  = ['#ff875f', 209]     " orange
" END MODIFIED COLORS

let s:gb.neutral_red    = ['#d65d0e', 166]     " 214-93-14
let s:gb.neutral_green  = ['#d79921', 172]     " 215-153-33
let s:gb.neutral_blue = ['#d79921', 172]     " 215-153-33
let s:gb.neutral_yellow   = ['#afafff', 147]      " 69-133-136
let s:gb.neutral_purple = ['#b16286', 132]     " 177-98-134
let s:gb.neutral_orange   = ['#689d6a', 72]      " 104-157-106
let s:gb.neutral_aqua = ['#ff875f', 209]     " 254-128-25

let s:gb.faded_red      = ['#af3a03', 130]     " 175-58-3
let s:gb.faded_green    = ['#b57614', 136]     " 181-118-20
let s:gb.faded_blue   = ['#b57614', 136]     " 181-118-20
let s:gb.faded_yellow     = ['#afafff', 147]      " 7-102-120
let s:gb.faded_purple   = ['#8f3f71', 96]      " 143-63-113
let s:gb.faded_orange     = ['#427b58', 66]      " 66-123-88
let s:gb.faded_aqua   = ['#ff875f', 209]     " 254-128-25
...
" Function name
hi! link Function GruvboxOrangeBold
